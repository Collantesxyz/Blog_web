		...
		<section class="read-container">
			...
			<div class="read-post">
				...
				<form method="post">
					...
					<div class="icons">
						<div class="likes"><i class="bx bx-heart"></i><span><?= $total_post_likes ?></span></div>
						<div class="comment"><i class="bx bx-chat"></i><span><?= $total_post_comments ?></span></div>
					</div>	
					<div class="flex-btn">
				...
				<div class="box-container">
					...
					<div class="box">
						...
						<form action="" method="post">
							...
							<button type="submit" class="option-btn" name="delete_comment" onclick="return confirm('delete this comment')">delete comment</button>
						</form>
					</div>
					<?php 
							}
							...
							echo '
									<div class="empty">
										<p>no comment added yet! <br><a href="add_posts.php" class="btn" style="margin-top: 1.5rem;">add post</a></p>
									</div>
								';
						}
					?>

...
<head>
	...
	<title>blog - Pagina de Inicio</title>
</head>
<body>
				...
				<div class="blog-section">
					...
					<div class="blog-header">
						<form action="search.php" method="post" class="search-form">
							<input type="text" name="search_box" maxlength="100" placeholder="buscar en el blog" required>
						...
						<div class="category-box">
							<ul>
								<li>
									...
									<ul class="sub-menu">
										<li><a href="category.php?category=nature" class="links">Categoria 1</a></li>
										<li><a href="category.php?category=education" class="links">Categoria 2</a></li>
										<li><a href="category.php?category=bussiness" class="links">Categoria 3</a></li>
										<li><a href="category.php?category=travel" class="links">Categoria 4</a></li>
										<li><a href="category.php?category=news" class="links">Categoria 5</a></li>
										<li><a href="category.php?category=gamming" class="links">Categoria 6</a></li>
										<li><a href="category.php?category=sports" class="links">Categoria 7</a></li>
										<li><a href="category.php?category=design" class="links">Categoria 8</a></li>
										<li><a href="category.php?category=fashion" class="links">Categoria 9</a></li>
										<li><a href="category.php?category=personal" class="links">Categoria 10</a></li>
					...
					<div class="posts-container">
						<h1 class="heading">Post más reciente</h1>
